...
const movieMocks =[{
    ...
    result: {
        data: {
            moviesBySearch: [
                {poster_path: "/6VZlm8sEwxkE3L5nXxz17QLj1sF.jpg", revenue: 100000, original_language: "Polish", title: "Corpus Christi", runtime: 118, genres: ["Action", "Drama"], id: "123", directors: [{id: 566109, name: "Jan Komasa"}], cast: [{id: 1609214, name: "Bartosz Bielenia"}, {id: 131695, name: "Aleksandra Konieczna"}]}, 
                {poster_path: "/hL3NqRE2ccR4Y2sYSJTrmalRjrz.jpg", revenue: 4300000, original_language: "Japanese", title: "Maquia: When the Promised Flower Blooms", runtime: 115, genres: ["Animation", "Fantasy", "Drama"], id: "1234", directors: [{id: 1257117, name: "Mari Okada"}], cast: [{id: 1835721, name: "Manaka Iwami"}, {id: 19588, name: "Miyu Irino"}]}
            ]
        }
    }
}]
